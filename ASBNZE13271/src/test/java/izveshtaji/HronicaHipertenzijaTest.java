...
public class HronicaHipertenzijaTest {

	@Test
	public void test() throws Exception {
		Bolesti b = main.before();
		Bolest hipertenzija = null;
		ArrayList<Bolest> bolesti = b.getBolesti();
		for (Bolest b1 : bolesti) {
			if (b1.getNazivBolesti().equals("hipertenzija")) {
				hipertenzija = b1;
			}
		}
		...
		PrepisanaTerapija p0 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p1 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p2 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p3 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p4 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p5 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p6 = new PrepisanaTerapija(hipertenzija, null, "", LocalDate.now(), 36, true);
