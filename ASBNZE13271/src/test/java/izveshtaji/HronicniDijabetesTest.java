...
public class HronicniDijabetesTest {
	@Test
	public void test() throws Exception {
		...
		PrepisanaTerapija p0 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p1 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p2 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p3 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p4 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p5 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p6 = new PrepisanaTerapija(dijabetes, null, "", LocalDate.now(), 36, true);
