...
public class HronicnaAkutnaBubreznaBolestTest {
	
	@Test
	public void test() throws Exception{
		Bolesti b = main.before();
		Bolest akutnaBubreznaBolest = null;
		ArrayList<Bolest>bolesti =b.getBolesti();
		for(Bolest b1 : bolesti) {
			if(b1.getNazivBolesti().equals("akutnaBubreznaBolest")) {
				akutnaBubreznaBolest = b1;
			}
		}
		...
		PrepisanaTerapija p0 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p1 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p2 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p3 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p4 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p5 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p6 = new PrepisanaTerapija(akutnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
