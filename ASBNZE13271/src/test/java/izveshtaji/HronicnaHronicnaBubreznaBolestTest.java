...
public class HronicnaHronicnaBubreznaBolestTest {
	...
	public void test() throws Exception {
		...
		PrepisanaTerapija p0 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p1 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p2 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p3 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p4 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p5 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
		PrepisanaTerapija p6 = new PrepisanaTerapija(hronicnaBubreznaBolest, null, "", LocalDate.now(), 36, true);
